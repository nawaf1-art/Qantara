...
class PiperTTS:
    def __init__(
        ...
        self.default_voice_id = next(iter(self.voices), None)
    ...
    def _load_voices(
        ...
        if os.path.exists(self.registry_path):
            ...
            for entry in payload.get("voices", []):
                ...
                resolved_config_path = self._resolve_path(entry.get("config_path")) if entry.get("config_path") else _default_config_path(resolved_model_path)
        ...
        fallback_voice_path = voice_path or _default_model_path()
