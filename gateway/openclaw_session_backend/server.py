...
OPENCLAW_AGENT_ID = os.environ.get("QANTARA_OPENCLAW_AGENT_ID", "main").strip() or "main"
OPENCLAW_TIMEOUT_SECONDS = float(os.environ.get("QANTARA_OPENCLAW_TIMEOUT", "300"))
...
def _build_openclaw_command(
    ...
    message = build_voice_turn_user_message(transcript, turn_context)
    command = [
        OPENCLAW_BIN,
        "agent",
        "--agent",
