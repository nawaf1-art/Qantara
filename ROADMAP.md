...
#### `0.2.3` — [Tier 1] Voice-as-API (HTTP/WS for any local app) — PREPARED AS `0.2.11`, SHIPPED IN `0.2.12`
...
#### `0.2.10` — Python SDK (`pip install qantara`) — RELEASED (2026-06-10; PyPI upload is a separate owner step)
